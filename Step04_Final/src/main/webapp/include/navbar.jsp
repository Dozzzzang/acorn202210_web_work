...
<nav class="navbar navbar-expand-lg bg-primary navbar-dark">
	<div class="container">
		<a class="navbar-brand" href="${pageContext.request.contextPath }/">
			<img
			src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ089Mun2QtaA5zfTh0PqYUkzbKoGH-1T0EzQ&usqp=CAU"
		...
		<div class="collapse navbar-collapse" id="navbarNav"
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item"><a
					class="nav-link <%= thisPage.equals("cafe") ? "active" : "" %>"
					href="${pageContext.request.contextPath }/cafe/list.jsp">게시판</a></li>
			</ul>
		</div>
	</div>
</nav>